...
function testSuite(config) {
    describe(config.title, function () {
        ...
        describe('event', function () {
            ...
            it('should escape control characters in data', function () {
                var formattedData = cal.defaults.formatter.format({
                    data: {
                        stack: 'Test stack\r\n\tat a.js:11:13\r\n\tat b.js:1:1\f\tat formfeed.js:1248:18'
                    }
                });

                assert.ok(/Test stack\\r\\n\\tat a\.js\:11\:13\\r\\n\\tat b.js\:1\:1\\f\\tat formfeed\.js\:1248\:18/g.test(formattedData));
            });

            it('should shorten Altus paths in stacktraces', function () {

                var formattedData = cal.defaults.formatter.format({
                    data: {
                        stack: 'trim_prefix (/x/ebay/cronus/software/service_nodes/.ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4-SLCB-CLav3h7ppevduo-10.74.42.234/installed-packages/p2pnodeweb/1.31.0_20160917005017236.unx/cronus/scripts/node_modules/express/lib/router/index.js:310:13) at /x/ebay/cronus/software/service_nodes/.ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4-SLCB-CLav3h7ppevduo-10.74.42.234/installed-packages/p2pnodeweb/1.31.0_20160917005017236.unx/cronus/scripts/node_modules/express/lib/router/index.js:280:7 at Function.process_params (/x/ebay/cronus/software/service_nodes/.ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4-SLCB-CLav3h7ppevduo-10.74.42.234/installed-packages/p2pnodeweb/1.31.0_20160917005017236.unx/cronus/scripts/node_modules/express/lib/router/index.js:330:12) at next (/x/ebay/cronus/software/service_nodes/.ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4.p2pnodeweb-app__ENVav3h5n6u6tv4-SLCB-CLav3h7ppevduo-10.74.42.234/installed-packages/p2pnodeweb/1.31.0_20160917005017236.unx/cronus/scripts/node_modules/express/lib/router/index.js:271:10'
                    }
                });

                var expected = 'stack=trim_prefix (/node_modules/express/lib/router/index.js:310:13) at /node_modules/express/lib/router/index.js:280:7 at Function.process_params (/node_modules/express/lib/router/index.js:330:12) at next (/node_modules/express/lib/router/index.js:271:10';
                assert.ok(formattedData.indexOf(expected) > -1);
            });
            ...
            it('should format in expected way', function () {
                var out = cal.formatter.cal.format({
                ...
                var re = new RegExp(
                    '^175\\t0\\t2\\tA\\d{2}:\\d{2}:41.39\\tRANDOM_CAL_STUFF' +
                    '\\tMayflyGet\\t2\\t0\\t' +
                    'key1=foo=foo1&key2=foo=foo2&key3=foo=foo3&' +
                    'corr_id_=936e2ff0e62f7\\r\\n$');
                assert.ok(re.test(out), out);
            });

          it('should format event in expected way', function () {
              var out = cal.formatter.cal.format({
                  type: 'BIZ',
                  name: 'ACCOUNT.CREATE',
                  status: '0',
              ...
              var re = new RegExp(
                  '^175\\t0\\t1\\tE\\d{2}:\\d{2}:\\d{2}.\\d{2}\\t' +
                  'BIZ\\tACCOUNT.CREATE\\t0\\t\\r\\n$');
              assert.ok(re.test(out), out);
          });

            it('should format when data.msg.length === 1', function () {
                var out = cal.formatter.cal.format({
                    'type': 'RANDOM_CAL_STUFF',
                    'name': 'MayflyGet',
                    'status': '2',
            ...
            it('should format when data.msg and other keys', function () {
                var out = cal.formatter.cal.format({
                    'type': 'RANDOM_CAL_STUFF',
                    'name': 'MayflyGet',
                    'status': '2',
            ...
            it('should not write data with known PII value into CAL', function () {
                var event = cal.createEvent('type', 'name');
                event.addData('msgCode', 'USER_LOGIN_SUCCESS');
                event.addData('msg', 'Login success and redirect to give return url: https://www.paypal.com/checkoutnow/2?flow=1-P&login_email=testuser@gmail.com&token=EC-1UL38236PB460920W&useraction=commit');
                event.complete();
            });
