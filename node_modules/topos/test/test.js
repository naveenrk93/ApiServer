...
describe('topos test suite', function () {
    ...
    describe('cache topo', function () {

        before(function (next) {
            process.env.CACHE_TOPOS = true;
            this.timeout(10000);
            remotopo.load(function () {
                topos.init(nconf.get('topos'), nconf);
                next();
        ...
        after(function(next) {
          process.env.CACHE_TOPOS = false;
          next();
        });

        it('should create a cache file', function(next) {
          var cachePath = path.resolve(__dirname, '..', 'toposcache.json');
          ...
          assert.deepEqual(topos.getDump(), {
          	"sample": {
          		"servicebridge": {
          			"host": "msmaster.qa.paypal.com",
          			"port": 12252,
          			"package": "asfdispatchbridgespartaweb"
          		},
          		"mayfly": {
                "host": "msmaster.qa.paypal.com",
                "hostname": "msmaster.qa.paypal.com",
          			"ipport": "1:msmaster.qa.paypal.com:10368",
          			"package": "mayfly-session",
                "port": 10368
          		},
          		"walletfiserv": {
          			"host": "msmaster.qa.paypal.com",
          			"port": 12300,
          			"package": "walletfiserv"
          		},
          		"accountmanagementserv": {
          			"host": "msmaster.qa.paypal.com",
          			"port": 10208,
          			"package": "accountmanagementserv"
          		},
          		"cal": {
          			"host": "msmaster.qa.paypal.com",
          			"port": 1118,
          		...
          		"wellsfargo_main_url": {
          			"url": "https://redxfer.wellsfargo.com",
          			"package": "wellsfargo_main_url_vip"
          		}
          	},
          	"modules": {
          		"moduleA": {
